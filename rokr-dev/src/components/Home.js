...
export default function Home(props) {
    React.useEffect(function() {
        // Load overall
        updateCircleProgress('overall_progress', props.overallProgressData.avgCompletion, 200, '50px', '#000718');
    ...
    return (
        <div>
            ...
            <div className="overall-panel mt-4">
                <ProgressCard progressId="overall_progress" data={props.overallProgressData} isTeam={false} />
            </div>
